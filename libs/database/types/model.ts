...
export interface IBaseAttribute {
    ...
    length?: number;
    primary?: boolean;
    /** Reject caller writes when strict validation is enabled. */
    readonly?: boolean;
    /** Describes values generated by database middleware. */
...
export interface IBaseModel {
    ...
    useEnabled?: boolean;
    useTree?: boolean;
    /** Adds a protected positive integer revision used for optimistic locking. */
    useRevision?: boolean;
}
